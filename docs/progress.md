...
| 33 | Outbound OAuth core (config, token store, injection, flow) | [task-33.md](tasks/task-33.md) | done |
...
| 34.1 | Browser auth for OAuth connection flow | [task-34.1.md](tasks/task-34.1.md) | done |
